    ...
    public SecurityFilterChain filterChain( final HttpSecurity http ) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests( authz -> authz
                        ...
                        // 2. IA / CHATBOT (Requiere ser Usuario logueado)
                        // El Gateway deja pasar si tienes token válido.
                        // La validación "PREMIUM" la hace el servicio de IA internamente.
//                        .requestMatchers("/api/ia/**").hasAuthority( AuthotityConstant._USUARIO )
                        .requestMatchers("/api/ia/**").hasAnyAuthority( AuthotityConstant._USUARIO, AuthotityConstant._ADMIN )
